...
/** Test suite for `Lifting`
  ...
  * lifted correctly.
  */
class LiftingSuite extends FunSuite {
  import operation.laws.Canonical.chsh

  val scenario_CHSH = "[(2 2) (2 2)]".fromText[Scenario]
  val scenario_222_222 = "[(2 2 2) (2 2 2)]".fromText[Scenario]
  val scenario_33_33 = "[(3 3) (3 3)]".fromText[Scenario]
  val scenario_22_33 = "[(2 2) (3 3)]".fromText[Scenario]
  ...
  test("Parsing of CHSH lifting to I3322") {
    ...
    val lifting = text.fromText[Lifting]
