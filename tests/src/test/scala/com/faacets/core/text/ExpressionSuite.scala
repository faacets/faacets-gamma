...
class ExpressionSuite extends FaacetsSuite {
  ...
  val valid: Seq[(String, String)] =
    Seq(
      ...
      "[(2 2) (2 2)]" -> "PA(1|1)",
      "[(2 2) (2 2)]" -> "PB(1|1)",
      "[(3 2) (2 2)]" -> "PAB(0,0|0,0) + PAB(0,0|0,1) + PAB(0,0|1,0) + PAB(0,0|1,1)-PAB(0,1|0,0) + PAB(0,1|0,1) + PAB(0,1|1,0) + PAB(0,1|1,1) -PAB(1,0|0,0) +      PAB(1,0|0,1) + PAB(1,0|1,0) + PAB(1,0|1,1)-PAB(1,1|0,0) + PAB(1,1|0,1) + PAB(1,1|1,0) + PAB(1,1|1,1)+PAB(2,0|0,0) + PAB(2,0|0,1) -PAB(2,1|0,0) + PAB(2,1|0,1) - PA(2|1)+1/4*PB(1|2)",
      "[(2 2) (2 2)]" -> "<A0B0>",
      "[(2 2) (2 2)]" -> "3/2<A0B0>",
      "[(2 2) (2 2)]" -> "3/2*<A0B0> + <A1> -<B1>-5<B0>"
    )

  val invalid: Seq[(String, String)] =
    Seq("[(2 2) (2 2)]" -> "P(0|0)",
      "[(2 2) (2 2)]" -> "P(1,2|1,1)",
      "[(2 2) (2 2)]" -> "P(00|00)",
      "[(2 2) (2 2)]" -> "P(0 0|0 0)",
  ...
  test("Valid examples") {
    valid.forall { case (scenario, expr) =>
      DExpr.parseExpression(scenario, expr).isValid shouldBe true
    }
  }
  
  test("Invalid examples") {
    invalid.forall { case (scenario, expr) =>
      DExpr.parseExpression(scenario, expr).isValid shouldBe true
    }
  }
